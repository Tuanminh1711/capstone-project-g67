...
export class AddPlantComponent implements OnInit, OnDestroy {
  ...
  private prepareRequestData() {
    ...
    return {
      ...
      plantingDate: plantingDate, // ISO 8601 format
  ...
  /**
   * Format Date to ISO 8601 format compatible with java.sql.Timestamp
   * Format: yyyy-MM-dd'T'HH:mm:ss.SSS'Z' (UTC timezone)
   */
