...
export class ReportListComponent implements OnInit, OnDestroy {
  ...
  private confirmationDialog = inject(ConfirmationDialogService) as ConfirmationDialogService;
  private jwtUserUtil = inject(JwtUserUtilService) as JwtUserUtilService;
