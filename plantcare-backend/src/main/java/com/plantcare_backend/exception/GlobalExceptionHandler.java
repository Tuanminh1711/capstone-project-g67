...
import org.springframework.security.access.AccessDeniedException; // Sửa import này
...
public class GlobalExceptionHandler {
    ...
    /**
     * bắt lỗi handleRuntimeException
     *
     * @param ex
     * @return
     */
    ...
    public ResponseEntity<ResponseError> handleVIPAccessException(VIPAccessException e) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(new ResponseError(HttpStatus.FORBIDDEN.value(), e.getMessage()));
    }
}
